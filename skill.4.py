...
# Optional: Needed only for hotspot map
try:
    import folium
...
# Robust datetime conversion; set errors='coerce' to handle format variations
...
# 1. Accidents by hour (time of day)
...
# 2. Top 10 weather conditions for accidents
plt.figure(figsize=(10, 4))
...
# 4. (Optional) Road surface condition if present
...
# 5. Severity by top weather conditions
...
# 6. Accident hotspots (interactive map, if folium is installed)
if folium_installed:
